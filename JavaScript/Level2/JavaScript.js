...
if (saveFile) {
    ...
    scoreValue.hitsNum = `${JSON.parse(localStorage.getItem("lv2Hit"))}`;
    scoreValue.missNum = `${JSON.parse(localStorage.getItem("lv2Miss"))}`;
}
...
const wrong = () => {
    ...
    if (scoreValue.missNum == 6) {
        ...
        localStorage.setItem("lv2Hit", JSON.stringify(scoreValue.hitsNum));
...
if (saveFile)
    ...
    if (timeNum == 120) {
        ...
        localStorage.setItem("totalScore", JSON.stringify(scoreValue.scoreNum));
        localStorage.setItem("lv2Hit", JSON.stringify(scoreValue.hitsNum));
        localStorage.setItem("lv2Miss", JSON.stringify(scoreValue.missNum));
        localStorage.setItem("Music", audio.currentTime);
        localStorage.setItem("time", 0);
        localStorage.setItem("saved", 0);
        window.location.href = "../../HTML/Level3/HtmlPage.html";
    }
}
